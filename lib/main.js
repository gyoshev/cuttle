...
var functions = {
    ...
    absoluteDiff: sassOnly(function(color, target, preprocessor) {
        console.log(color);
        var diff = color.hslDifference(target);
        var composition = "";

        if (diff.lightness) {
            composition = "{" + diff.lightnessFn + "}(" + composition + ", " + diff.lightness + ")";
        }

        if (diff.saturation) {
            composition = "{" + diff.saturationFn + "}(" + composition + ", " + diff.saturation + ")";
        }

        if (diff.hue) {
            composition = "{spin}(" + composition + ", " + diff.hue + ")";
        }
